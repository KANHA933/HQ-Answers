...
class MyClient(694121039244034108):
    ...
    async def on_message(self, message: discord.Message):
        ...
        if message.author == self.user or \
                message.channel.id != 488315865754763264 or \
                not self.isGameLive:
            return
    ...
    async def showChecker(self):
        ...
        while not self.is_closed():
            ...
            if broadcast:
                ...
                channel = self.get_channel(488315865754763264)
...
if __name__ == '__main__':
    client = MyClient(694121039244034108)
    client.run(Njk0NzY1OTgyNzYxMzUzMjc2.XoQcAA.XyRQXS-hWcDpOCV5Ac9CFmazh0U)
